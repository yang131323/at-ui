/*! AT-UI v1.3.4 | https://at.aotu.io | (c) 2017 O2Team | MIT License */
  ...
  return _c('div', {
    ...
    on: {
      ...
      "keydown": [function($event) {
        ...
        return _vm.increaseNum($event)
      }, function($event) {
        if (!$event.type.indexOf('key') && _vm._k($event.keyCode, "down", 40, $event.key, ["Down", "ArrowDown"])) { return null; }
        $event.stopPropagation();
        $event.preventDefault();
        return _vm.decreaseNum($event)
      }]
    }
  })]), _vm._v(" "), _c('div', {
...
var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('transition', {
    ...
    class: ( _obj = {}, _obj[("at-notification--" + _vm.type)] = _vm.type, _obj['at-notification--with-message'] =  _vm.message, _obj['at-notification--hover'] =  !_vm.showClose, _obj ),
    style: ({
      top: _vm.top ? _vm.top + 'px' : 'auto'
    }),
    on: {
